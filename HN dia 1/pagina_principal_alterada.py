...
class SistemaGestao:
    def _init_(self, master=None):
        ...
        self.menu_arquivo.add_command(label="Sair", command=self.sairAplicativo)
        ...
        # Adicionar imagem (opcional, removido para clareza)
        # self.img = PhotoImage(file="imagem/image.png")
        # self.lbimg = Label(self.janela, image=self.img)
        # self.lbimg.pack()
        ...
        self.btn_sair = Button(self.janela_botoes, text="Sair", font=self.fontePadrao, width=10,
                               command=self.sairAplicativo)
    ...
    def sairAplicativo(self):
        self.master.destroy()  # Fecha a aplicação
